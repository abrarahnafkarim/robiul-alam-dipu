...
const Hero = () => {
  ...
  return (
    <section className="hero-section" style={{
      ...
      <div className="hero-bg-blob-1" style={{ position: 'absolute', top: '-10%', left: '10%', width: '500px', height: '500px', backgroundColor: 'rgba(212, 175, 55, 0.03)', borderRadius: '50%', filter: 'blur(50px)', zIndex: 0 }} />
      <div className="hero-bg-blob-2" style={{ position: 'absolute', bottom: '-20%', right: '-10%', width: '600px', height: '600px', backgroundColor: 'rgba(212, 175, 55, 0.02)', borderRadius: '50%', zIndex: 0, border: '1px solid rgba(212, 175, 55, 0.1)' }} />

      <div className="container grid grid-cols-2 hero-container" style={{ position: 'relative', zIndex: 1, alignItems: 'flex-end', gap: '4rem' }}>
        
        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="hero-text-content" style={{ paddingTop: '0', paddingBottom: '4rem' }}>
          ...
          <h1 className="hero-title" style={{ color: 'var(--color-text)', marginBottom: '1rem', lineHeight: '1.05' }}>
            {heroData.name}<br/>{heroData.title}
          </h1>
          
          <p className="hero-description" style={{ color: 'rgba(255,255,255,0.8)', marginBottom: '2.5rem', maxWidth: '500px' }}>
